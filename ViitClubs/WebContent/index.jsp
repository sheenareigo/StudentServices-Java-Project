...
<!-- navbar starts -->
		 ...
		 <div class="container text-uppercase p-2">
		  <a class="navbar-brand font-weight-bold text-white" href="#">Life @Lambton</a>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    ...
		    <!--   <li class="nav-item">
		      ...
		      --> 
		      <li class="nav-item">
		        <a class="nav-link" href="#contactus-div">Feedback</a>
		      </li> 
		       <li class="nav-item active">
		        <a class="nav-link" href="showclubActivities">Club Activities <span class="sr-only">(current)</span></a>
		      </li>
		    </ul>
		  </div>
		 </div>
...
<!--  sixth section starts-->
	<section class="clients-feedback" id="clients-feedback-div">
  		<div class="container headings text-center">
  			...
  			<p class="text-center text-capitalize">
  				Lambton has various technical, cultural, social clubs
  			</p>
  		</div><br/>
  		<div class="container">
			  ...
			  <div class="carousel-inner container">
				<!-- add 4 carousel items in carousel -->
					...
					<%	String firstCarouselItem="active";
	  					...
	  					System.out.println("Student Id in Index : "+studentId);
					...
					<%for(int j=0; j<3; j++){ %>		      
					      	<div class="col-lg-4 col-md-4 col-12">
					      		<div class="box">
					      			<% System.out.println("Student Id in Index inside tag : "+studentId);  
					%>	
					      			<a href="./clubDetails?id=<%=clubs.get(cardArrayListIndex).getClubid() %>&username=<%= studentId %>"><img src="./showicon?id=<%=clubs.get(cardArrayListIndex).getClubid()%>" class="img-fluid img-thumbnail"></a>
					      			<p class="m-4 text-lowercase">
					      				<%=clubs.get(cardArrayListIndex).getClubvision().substring(0, 5)+"..."%>	
					      			</p>
...
<!-- seventh section form starts -->
	<section class="contactus" id="contactus-div">
  		<div class="container headings text-center">
  			<h1 class="text-center font-weight-bold text-capitalize">Feedback</h1>
  			<p class="text-center text-capitalize">
