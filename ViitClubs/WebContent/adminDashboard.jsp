		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav ml-auto text-uppercase">
		      ...
		      <li class="nav-item active">
		        <a class="nav-link text-light" href="showadmindashboard">Dashboard <span class="sr-only">(current)</span></a>
		      </li>
		      
		      <li class="nav-item">
		        <a class="nav-link text-light" href="showenrollment">Enrollment</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link text-light" href="showcustomerfeedbacks">Feedbacks</a>
		      </li> 
		      <li class="nav-item">
		        <a class="nav-link text-light" href="homepage">Life @ Lambton</a>
		      </li>   
		      <li class="nav-item text-light">
		      	<%
           	    if(session.getAttribute("username")==null){ response.sendRedirect("adminlogin"); }
           		 %>
		        <a class="nav-link text-light" href="adminlogin">Hello,<%= session.getAttribute("username") %>&nbsp;<i class="fa fa-sign-out fa-lg" aria-hidden="true"></i></a>
		      </li> 
		    </ul>
		  </div>
		 </div>
